...
class EditCourse:
    def __init__(self, frame):
        ...
        self.add_course_id_entry = Entry(self.edit_course_frame, textvariable=self.course_id, highlightthickness=2,
                                         highlightbackground="#A51d23", font=("Bebas Neue", 18))
        self.add_course_text = Text(self.edit_course_frame, highlightthickness=2, highlightbackground="#A51d23",
                                    font=("Bebas Neue", 18))
        ...
        update_info_button = Button(self.edit_course_frame, command='', text="UPDATE",
